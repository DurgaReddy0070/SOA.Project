...
public class Event {
    ...
    private String dietaryRequirements; // Comma separated, e.g. "VEG,NON_VEG,JAIN"

    private String cuisinePreferences; // Comma separated, e.g. "South Indian, North Indian, Continental"
